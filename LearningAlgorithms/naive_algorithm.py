...
class RandomAlgorithm(SequenceAlgorithm):
    ...
    def _buy_features(self, given_features: list[int], maximal_cost: float) -> list[int]:
        ...
        """
        available_features = get_complementary_list(range(self._train_samples.samples.shape[1]), given_features)
...
class OptimalAlgorithm(SequenceAlgorithm):
    ...
    def _buy_features(self, given_features: list[int], maximal_cost: float) -> list[int]:
        ...
        :return: the updated given features including all the chosen features.
        """
        available_features = list(get_complementary_list(range(self._train_samples.samples.shape[1]), given_features))
